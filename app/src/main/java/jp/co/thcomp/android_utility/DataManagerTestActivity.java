...
public class DataManagerTestActivity extends AppCompatActivity {
        ...
        RuntimePermissionUtil.requestPermissions(this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE}, new RuntimePermissionUtil.OnRequestPermissionsResultListener() {
            ...
            public void onRequestPermissionsResult(String[] permissions, int[] grantResults) {
                ...
                if(allGrants){
                    ...
                    mDataManager = new TestDataManager(DataManagerTestActivity.this, 1);
    ...
    private class ExpandDatabaseTask extends AsyncTask<Void, Void, List<TestData>> {
        ...
        protected void onPreExecute() {
            ...
            mDialog = new ProgressDialog(DataManagerTestActivity.this);
        ...
        protected void onPostExecute(List<TestData> dataList) {
            ...
            LayoutInflater inflater = DataManagerTestActivity.this.getLayoutInflater();
            LinearLayout llDataList = (LinearLayout) DataManagerTestActivity.this.findViewById(R.id.llDataList);
